...
/**
 * DTO для запроса регистрации нового пользователя. Содержит все необходимые поля для создания
 * учетной записи с валидацией.
 */
@Data
@Builder
@NoArgsConstructor
...
public class SignUpRequest {
  ...
  /**
   * Уникальное имя пользователя для входа в систему. Должно содержать только латинские буквы, цифры
   * и подчеркивание.
   */
  ...
  /** Электронная почта пользователя. Должна быть в валидном формате email. */
  ...
  /** Пароль пользователя. Должен соответствовать требованиям безопасности. */
